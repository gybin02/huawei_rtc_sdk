...
//    AgoraRtcEngine.create('e8e50ed12b8040c4a1a964fa551bd57c');
//
...
//        (String channel, String uid, int elapsed) {
//      setState(() {
...
//    };
//
//    AgoraRtcEngine.onUserJoined = (String uid, int elapsed) {
//      setState(() {
...
//    };
//
//    AgoraRtcEngine.onUserOffline = (String uid, int reason) {
//      setState(() {
...
//        (String uid, int width, int height, int elapsed) {
//      setState(() {
...
//  }
//
//  VideoSession _getVideoSession(String uid) {
...
//  int viewId;
//
//  VideoSession(String uid, Widget view) {
//    this.uid = uid;
//    this.view = view;
//  }
//}
